...
image_path = 'example.jpeg'  # User-provided image path
...
cv2.putText(image_rgb,f"Height:{height}",height_label_position,font,0.8,(255,255,0),2,cv2.LINE_AA)
plt.figure(figsize=(12,8))
plt.imshow(image_rgb)
plt.title('Annotated image with region, centers, bi-directional arrows')
plt.axis('off')
plt.show()